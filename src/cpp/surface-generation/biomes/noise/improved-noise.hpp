...
public:
    ...
    double noiseWithDerivative(double x, double y, double z, double output[]) {
        ...
        return this->sampleWithDerivative(intXwithOffset, intYwithOffset, intZwithOffset, xFract, yFract, zFract,
                                          output);
    }
...
private:
    ...
    double sampleWithDerivative(int32_t x, int32_t y, int32_t z, double xFract, double yFract, double zFract,
        ...
        double interpolatedGradientX =
            Mth::lerp3(smoothXfract, smoothYfract, smoothZfract, (double)gradient0[0], (double)gradient1[0],
                       (double)gradient2[0], (double)gradient3[0], (double)gradient4[0], (double)gradient5[0],
                       (double)gradient6[0], (double)gradient7[0]);
        double interpolatedGradientY =
            Mth::lerp3(smoothXfract, smoothYfract, smoothZfract, (double)gradient0[1], (double)gradient1[1],
                       (double)gradient2[1], (double)gradient3[1], (double)gradient4[1], (double)gradient5[1],
                       (double)gradient6[1], (double)gradient7[1]);
        double interpolatedGradientZ =
            Mth::lerp3(smoothXfract, smoothYfract, smoothZfract, (double)gradient0[2], (double)gradient1[2],
                       (double)gradient2[2], (double)gradient3[2], (double)gradient4[2], (double)gradient5[2],
                       (double)gradient6[2], (double)gradient7[2]);
