...
function makeStateRule(p_194811_: Blocks): SurfaceRules.RuleSource {
    //return SurfaceRules.state(p_194811_.defaultBlockState());
}

export namespace SurfaceRules {
    ...
    export class SurfaceRuleData {
        ...
        public static overworldLike(
            ...
            const isFrozenOcean = SurfaceRules.isBiome(
                Biomes.FROZEN_OCEAN,
                    ...
                    SurfaceRules.sequence(
                        SurfaceRules.ifTrue(
                            ...
                            SurfaceRules.ifTrue(
                                ...
                                SurfaceRules.sequence(
                                    SurfaceRules.ifTrue(
                                        surfacerules$conditionsource13,
                                        COARSE_DIRT
                                    ),
                                    SurfaceRules.ifTrue(
                                    ...
                                    SurfaceRules.ifTrue(
                                        surfacerules$conditionsource15,
                                        COARSE_DIRT
                                    ),
                                    replaceGrassWithDirtIfWaterIsAbove
                                )
