...
if (!Object.getOwnPropertyDescriptor(Module["ready"], "_check")) {
 Object.defineProperty(Module["ready"], "_check", {
  configurable: true,
  get: function() {
   abort("You are getting _check on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
 Object.defineProperty(Module["ready"], "_check", {
  configurable: true,
  set: function() {
   abort("You are setting _check on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
}
...
if (!Object.getOwnPropertyDescriptor(Module["ready"], "_print_memory_stats")) {
 Object.defineProperty(Module["ready"], "_print_memory_stats", {
  configurable: true,
  get: function() {
   abort("You are getting _print_memory_stats on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
 Object.defineProperty(Module["ready"], "_print_memory_stats", {
  configurable: true,
...
if (!Object.getOwnPropertyDescriptor(Module["ready"], "_get_input_queue_ptr")) {
 Object.defineProperty(Module["ready"], "_get_input_queue_ptr", {
  configurable: true,
  get: function() {
   abort("You are getting _get_input_queue_ptr on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
 Object.defineProperty(Module["ready"], "_get_input_queue_ptr", {
  configurable: true,
  set: function() {
   abort("You are setting _get_input_queue_ptr on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
}

if (!Object.getOwnPropertyDescriptor(Module["ready"], "_get_output_queue_ptr")) {
 Object.defineProperty(Module["ready"], "_get_output_queue_ptr", {
  configurable: true,
  get: function() {
   abort("You are getting _get_output_queue_ptr on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
 Object.defineProperty(Module["ready"], "_get_output_queue_ptr", {
  configurable: true,
  set: function() {
   abort("You are setting _get_output_queue_ptr on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
}
...
var ___heap_base = Module["___heap_base"] = 5849888;
